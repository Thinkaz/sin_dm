...
<footer class="footer_footer__10U2P">
            <nav aria-label="Vercel Directory" role="navigation">
                <div class="footer_group__2wBl3">
                    <input type="checkbox" id="footer-group-13" class="footer_hidden__29DDw reset_visuallyHidden__2iNSu" aria-label="Open Navigation Menu" />
                    <label for="footer-group-13">
                        <h3>Lorem</h3>
                    </label>
                    <ul class="footer_list__2DLed">
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/solutions/nextjs">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/solutions/react">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/solutions/gatsby">Ipsum</a>
                        </li>
                    </ul>
                </div>
                <div class="footer_group__2wBl3">
                    <input type="checkbox" id="footer-group-14" class="footer_hidden__29DDw reset_visuallyHidden__2iNSu" aria-label="Open Navigation Menu" />
                    <label for="footer-group-14">
                        <h3>Lorem</h3>
                    </label>
                    <ul class="footer_list__2DLed">
                        <li class="footer_item__1gPLb">
                            <a href="/docs" target="_blank" rel="noopener" class="link_link__2vTGP link_secondary__2oupT">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/experts">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/customers">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a href="/guides" target="_blank" rel="noopener" class="link_link__2vTGP link_secondary__2oupT">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a href="/support" target="_blank" rel="noopener" class="link_link__2vTGP link_secondary__2oupT">Ipsum</a>
                        </li>
                    </ul>
                </div>
                <div class="footer_group__2wBl3">
                    <input type="checkbox" id="footer-group-15" class="footer_hidden__29DDw reset_visuallyHidden__2iNSu" aria-label="Open Navigation Menu" />
                    <label for="footer-group-15">
                        <h3>Lorem</h3>
                    </label>
                    <ul class="footer_list__2DLed">
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/home">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/blog">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/changelog">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/about">Ipsum</a>
                        </li>
                    </ul>
                </div>
                <div class="footer_group__2wBl3">
                    <input type="checkbox" id="footer-group-16" class="footer_hidden__29DDw reset_visuallyHidden__2iNSu" aria-label="Open Navigation Menu" />
                    <label for="footer-group-16">
                        <h3>Lorem</h3>
                    </label>
                    <ul class="footer_list__2DLed">
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/legal/privacy-policy">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/legal/terms">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/legal/trademark-policy">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/legal/inactivity-policy">Ipsum</a>
                        </li>
                        <li class="footer_item__1gPLb">
                            <a class="link_link__2vTGP link_secondary__2oupT" href="/legal/dmca-policy">Ipsum</a>
                        </li>
                    </ul>
                </div>
            </nav>
            <section>
                ...
                <div class="footer_wrapper__yyk_H">
                    <span class="footer_copyright__7_9m2">
                        <span>Copyright</span>
                        © 2021 Tequila. All rights reserved.
                    </span>
                </div>
            </section>
        </footer>
